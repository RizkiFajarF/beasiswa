...
<nav>
    ...
    //nama karyawan disimpan dalam araray $nama_karyawan['nama'];
        ...
        $query="SELECT no_pengajuan,nama,mulai_kerja,nama_anak,pendidikan,ranking,ipk,alamat_berkas_nilai,alamat_berkas_baik,status_pengajuan,ket_status,no_pengajuan FROM pengajuan";
